/*
感谢ZIYE提供的小程序打卡模板
说明：以早起习惯养成记为例的打卡模版，可以抓包然后替换以下内容来制作其他打卡脚本
手动替换（从上到下）:
szgb.tzxx.net.cn
szgb\.tzxx\.net\.cn
早起习惯养成记
...
1、hostname= szgb.tzxx.net.cn,



surge:本地
早起习惯养成记小程序 = type=http-request,pattern=^ https:\/\/szgb\.tzxx\.net\.cn\/*,requires-body=1,max-size=0,script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/zqxgycj.js


圈x:本地
https:\/\/szgb\.tzxx\.net\.cn\/* url script-request-header https://raw.githubusercontent.com/Huxiaoka/Script/master/zqxgycj.js

# 早起习惯养成记小程序
http-request ^https:\/\/szgb\.tzxx\.net\.cn\/* script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/zqxgycj.js, requires-body=true, timeout=10, tag=早起习惯养成记小程序

# 早起习惯养成记小程序
cron "0 0 * * * *" script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/zqxgycj.js, tag=早起习惯养成记小程序
...
const dkurlkey = 'zqxgycjurl'+jbid
