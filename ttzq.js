/*
感谢ZIYE提供的小程序打卡模板
说明：以天天早起为例的打卡模版，可以抓包然后替换以下内容来制作其他打卡脚本
手动替换（从上到下）:
cw.gxgxlpg.com
天天早起
cs = 10
...
1、hostname= cw.gxgxlpg.com,



surge:本地
天天早起小程序 = type=http-request,pattern=^ https:\/\/cw\.gxgxlpg\.com\/*,requires-body=1,max-size=0,script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/ttzq.js


圈x:本地
https:\/\/cw\.gxgxlpg\.com\/* url script-request-header https://raw.githubusercontent.com/Huxiaoka/Script/master/ttzq.js

# 天天早起小程序
http-request ^https:\/\/cw\.gxgxlpg\.com\/* script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/ttzq.js, requires-body=true, timeout=10, tag=天天早起小程序

# 天天早起小程序
cron "0 0 * * * *" script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/ttzq.js, tag=天天早起小程序
