/*
感谢ZIYE提供的小程序打卡模板
说明：以早起打卡赚零钱为例的打卡模版，可以抓包然后替换以下内容来制作其他打卡脚本
手动替换（从上到下）:
lljz.shujumagician.com
早起打卡赚零钱
cs = 20
xj = 88
zqdkzlqurl
...
1、hostname= lljz.shujumagician.com,



surge:本地
早起打卡赚零钱小程序 = type=http-request,pattern=^ https:\/\/lljz\.shujumagician\.com\/*,requires-body=1,max-size=0,script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/zqdkzlq.js


圈x:本地
https:\/\/lljz\.shujumagician\.com\/* url script-request-header https://raw.githubusercontent.com/Huxiaoka/Script/master/zqdkzlq.js

# 早起打卡赚零钱小程序 (loon)
http-request ^https:\/\/lljz\.shujumagician\.com\/* script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/zqdkzlq.js, requires-body=true, timeout=10, tag=早起打卡赚零钱小程序

# 早起打卡赚零钱小程序 (loon)
cron "0 0 * * * *" script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/zqdkzlq.js, tag=早起打卡赚零钱小程序
...
const dkurlkey = 'zqdkzlqurl'+jbid
