/*
感谢ZIYE提供的小程序打卡模板
说明：以今日早起王为例的打卡模版，可以抓包然后替换以下内容来制作其他打卡脚本
手动替换（从上到下）:
m.561000.com
m\.561000\.com
今日早起王
...
1、hostname= m.561000.com,



surge:本地
今日早起王小程序 = type=http-request,pattern=^ https:\/\/m\.561000\.com\/*,requires-body=1,max-size=0,script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/jrzqw.js


圈x:本地
https:\/\/m\.561000\.com\/* url script-request-header https://raw.githubusercontent.com/Huxiaoka/Script/master/jrzqw.js

# 今日早起王小程序
http-request ^https:\/\/m\.561000\.com\/* script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/jrzqw.js, requires-body=true, timeout=10, tag=今日早起王小程序

# 今日早起王小程序
cron "0 0 * * * *" script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/jrzqw.js, tag=今日早起王小程序
...
function GetCookie() {
if ($request && $request.url.match(/i=29&/))
