...
1、hostname= zm.shujumagician.com,



surge:本地
打卡 = type=http-request,pattern=^ https:\/\/zm\.shujumagician\.com\/*,requires-body=1,max-size=0,script-path= wdkzqdk.js


圈x:本地
https:\/\/zm\.shujumagician\.com\/* url script-request-header wdkzqdk.js

loon:本地
http-request ^ https:\/\/zm\.shujumagician\.com\/* script-path= wdkzqdk.js, requires-body=true, timeout=10, tag=打卡
...
const dkurlkey = 'wdkzqdkurl'+jbid
