/*
感谢ZIYE提供的小程序打卡模板
说明：以每天早起打卡赚钱为例的打卡模版，可以抓包然后替换以下内容来制作其他打卡脚本
手动替换（从上到下）:
ph0001.hezyq.com
ph0001\.hezyq\.com
每天早起打卡赚钱
...
surge:本地
每天早起打卡赚钱小程序 = type=http-request,pattern=^ https:\/\/ph0001\.hezyq\.com\/*,requires-body=1,max-size=0,script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/mtzqdkzq.js


圈x:本地
https:\/\/ph0001\.hezyq\.com\/* url script-request-header https://raw.githubusercontent.com/Huxiaoka/Script/master/mtzqdkzq.js

# 每天早起打卡赚钱小程序
http-request ^https:\/\/ph0001\.hezyq\.com\/* script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/mtzqdkzq.js, requires-body=true, timeout=10, tag=每天早起打卡赚钱小程序

# 每天早起打卡赚钱小程序
cron "0 0 * * * *" script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/mtzqdkzq.js, tag=每天早起打卡赚钱小程序
...
const dkurlkey = 'mtzqdkzqurl'+jbid
