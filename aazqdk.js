/*
感谢ZIYE提供的小程序打卡模板
说明：以安安早起打卡为例的打卡模版，可以抓包然后替换以下内容来制作其他打卡脚本
手动替换（从上到下）:
xcx.lehuo521.com
xcx\.lehuo521\.com
安安早起打卡
...
1、hostname= xcx.lehuo521.com,



surge:本地
安安早起打卡小程序 = type=http-request,pattern=^ https:\/\/xcx\.lehuo521\.com\/*,requires-body=1,max-size=0,script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/aazqdk.js


圈x:本地
https:\/\/xcx\.lehuo521\.com\/* url script-request-header https://raw.githubusercontent.com/Huxiaoka/Script/master/aazqdk.js

# 安安早起打卡小程序
http-request ^https:\/\/xcx\.lehuo521\.com\/* script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/aazqdk.js, requires-body=true, timeout=10, tag=安安早起打卡小程序

# 安安早起打卡小程序
cron "0 0 * * * *" script-path= https://raw.githubusercontent.com/Huxiaoka/Script/master/aazqdk.js, tag=安安早起打卡小程序
...
function GetCookie() {
if ($request && $request.url.match(/i=156&/))
